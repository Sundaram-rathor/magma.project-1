...
gsap.to("#page7-inner-circl",{
  
  scale:3,
  backgroundColor:"#1136ca8e",
  scrollTrigger:{
    trigger:"#page7-inner-circl",
    scroller:"#main",
    start:"top center",
    end:"bottom top",
    scrub:3
...
function canvas3(){
  const canvas = document.querySelector("#page11>#p11-can>canvas");
const context = canvas.getContext("2d");
